...
pub trait Input {
        ...
        unsafe fn next_maybe(
                &self,
                offset: Self::Offset,
        ) -> (Self::Offset, Option<Self::TokenMaybe<'_>>);
...
#[doc(hidden)]
pub struct SpannedTokenMaybe<'a, I: Input + 'a, T, S>(I::TokenMaybe<'a>, PhantomData<(T, S)>);
...
impl<T, S: Span + Clone, I: Input<Token = (T, S)>> Input for SpannedInput<T, S, I> {
        ...
        type Span = S;
        type TokenMaybe<'a> = SpannedTokenMaybe<'a, I, T, S> where I: 'a, S: 'a, T: 'a;
